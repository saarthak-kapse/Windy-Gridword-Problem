...
grid = Windy_Gridworld(number_of_rows=7,number_of_columns=10,start_state=[3,0],goal_state=[3,7],vertical_wind_pattern=[0,0,0,1,1,1,2,2,1,0])
...
print('Task3 Fastest Route Time:',(time_step_list[-1]-time_step_list[-10])/10)
